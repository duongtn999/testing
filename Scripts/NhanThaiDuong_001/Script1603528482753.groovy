...
WebUI.verifyElementText(findTestObject('Object Repository/Page_UP Portal  HoChiMinh University of Pedagogy/td_THANH CNG C'), 
    'Thanh Công Cụ')

WebUI.waitForElementPresent(findTestObject('Object Repository/Page_UP Portal  HoChiMinh University of Pedagogy/td_THANH CNG C'), 
    30)
